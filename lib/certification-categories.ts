...
export const certificationCategories: CertificationCategory[] = [
  {
    ...
    intro:
      "Explore security credentials across foundational cybersecurity, SOC operations, penetration testing, cloud security, governance, and advanced security leadership.",
  },
  {
    name: "Cloud",
    slug: "cloud",
    ...
    intro:
      "Compare cloud credentials for fundamentals, administration, architecture, security, and multi-cloud career development.",
  },
  {
    name: "Networking",
    slug: "networking",
    ...
    intro:
      "Build networking skills with credentials covering network fundamentals, administration, troubleshooting, and Cisco technologies.",
  },
  {
    name: "DevOps",
    slug: "devops",
    ...
    intro:
      "Explore credentials that support DevOps roles through Linux, Kubernetes, infrastructure as code, automation, and cloud-native operations.",
  },
  {
    name: "Data",
    slug: "data",
    ...
    intro:
      "Explore certifications for data analytics, database administration, and foundational data skills used across modern IT teams.",
  },
  {
    name: "GRC and Audit",
    slug: "grc-and-audit",
    ...
    intro:
      "Explore professional credentials for governance, risk management, compliance, security management, and IT auditing.",
  },
  {
    name: "IT Support",
    slug: "it-support",
    ...
    intro:
      "Start with credentials built around troubleshooting, hardware, software, security, and the practical foundations of IT support.",
  },
  {
    name: "Linux",
    slug: "linux",
    ...
    intro:
      "Explore credentials for Linux administration, command-line operations, troubleshooting, security, and systems support.",
  },
  {
    name: "Infrastructure",
    slug: "infrastructure",
    ...
    intro:
      "Explore certifications focused on servers, systems operations, hardware, storage, security, and enterprise infrastructure support.",
  },
  {
    ...
    intro:
      "Explore project management credentials that support planning, delivery, leadership, and structured execution across IT initiatives.",
  },
];
