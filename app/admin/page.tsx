...
const catalogAreas = [
  ...
  },
  {
    ...
    name: "Certifications",
    description:
      "Manage certification facts, status, SEO, and featured records.",
  ...
  },
  {
    ...
    name: "Exams",
    description:
      "Manage exam details, registration links, and verification dates.",
    href: "/admin/exams",
  },
  {
    key: "examDomains",
    name: "Exam domains",
    description:
      "Manage domain summaries, weights, and display order.",
  ...
  },
  {
    ...
    description:
      "Manage renewal guidance, official sources, and verification dates.",
  ...
  },
  {
    ...
    name: "Resources",
    description:
      "Manage official and community learning resources.",
  ...
  },
  {
    ...
    name: "Career paths",
    description:
      "Manage career-roadmap pages and SEO metadata.",
  ...
  },
  {
    ...
    description:
      "Manage ordered certifications and practical activities.",
  ...
  },
  {
    ...
    description:
      "Manage before, after, alternative, and specialization links.",
...
export default async function AdminPage() {
  ...
  const [
    ...
    supabase
      ...
      .select("id", { count: "exact", head: true })
      .or(
        `last_verified_date.is.null,last_verified_date.lt.${reviewThreshold}`,
      ),
  ...
  if (results.some((result) => result.error)) {
    throw new Error(
      "Unable to load admin dashboard counts.",
    );
  }
  ...
  const counts = {
    ...
    certificationRelations:
      certificationRelationsResult.count ?? 0,
  };

  const totalCatalogRecords = Object.values(counts).reduce(
      ...
      >
        <Card>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">
            This route performs a server-side role check
            before catalog tools are shown.
          </p>
        </Card>
        ...
        <Card>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Live total across all {catalogAreas.length}{" "}
            admin-managed catalog areas.
          </p>
        </Card>
        ...
        <Card>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Certification, exam, renewal, and resource
            records with no verification date or a date
            older than 90 days.
          </p>
      ...
      >
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-slate-600">
            Search, filter, create, edit, and safely remove
            catalog records from each protected admin area.
          </p>
        </div>
