...
const description =
  "Explore IT certifications, exam requirements, costs, career paths, study resources, renewal options, and certification comparisons with AimToCert.";

export const metadata: Metadata = {
  title: "AimToCert | Your Guide to IT Certifications",
  description,
  alternates: {
    canonical: "/",
  },
    ...
    <>
          ...
          <HeroPanel>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-300">
                  Choose the place that matches what you need next.
                </p>
              </div>
            </div>
              ...
              <Link href="/certifications" className="block">
                <HeroOption className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-sm text-slate-300">
                      Browse verified certification details, exams, and
                      career fit.
                    </p>
                  </div>
              ...
              <Link href="/career-paths" className="block">
                <HeroOption className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-sm text-slate-300">
                      See role-focused roadmaps and recommended next
                      steps.
                    </p>
                  </div>
              ...
              <Link href="/study-store" className="block">
                <HeroOption className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-sm text-slate-300">
                      Discover books, guides, and learning providers.
                    </p>
                  </div>
            ...
            <div className="mt-5 border-t border-white/10 pt-5">
              <p className="text-sm text-slate-300">
                <span className="mr-2 text-3xl font-black text-blue-300">
                  {certificationCount}
                </span>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
          Explore trusted certifications, map career roadmaps, and build
          a practical plan for your next IT role with clear,
        ...
        <div className="mt-9 flex flex-wrap gap-x-7 gap-y-3 text-sm text-slate-300">
          ...
          <span className="inline-flex items-center gap-2">
            <BookOpenCheck className="size-4 text-blue-300" />
            Verified details
          </span>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-slate-600">
            Explore your options, understand the details, and turn your
            next certification goal into a clear plan.
          </p>
        </div>
          ...
          {orderedFeaturedCertifications.length > 0 ? (
            ...
            <Card className="mt-8 text-center">
              <p className="text-slate-600">
                Featured certifications will appear here as the catalog
                is published.
              </p>
            </Card>
          )}
