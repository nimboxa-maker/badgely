        ...
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8 lg:py-20">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              Badgely maps certification owners to the testing and proctoring
              services candidates actually use. Compare Pearson VUE, PSI,
              PeopleCert, Certiport, Red Hat, Prometric and vendor-specific
              delivery without confusing the exam owner with the exam platform.
            </p>
          </div>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 leading-7 text-slate-600">
            These are the major delivery platforms you are likely to encounter
            while scheduling IT certification exams. The exact options can
            still vary by exam, country and program.
          </p>
        </div>
      ...
      <section className="border-y border-slate-200 bg-slate-50">
        <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 leading-7 text-slate-600">
              Use this directory to identify the exam-delivery platform before
              you buy a voucher, schedule an appointment or prepare a computer
              for remote testing.
            </p>
          </div>
          ...
          <p className="mx-auto mt-5 max-w-3xl text-center text-sm leading-6 text-slate-500">
            This directory focuses on mainstream IT and technology certification
            programs. Testing relationships change, and individual exams within
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-bold text-slate-950">
                  Confirm the provider on the certification owner&apos;s
                  official scheduling page.
                </h2>

                <p className="mt-3 max-w-3xl leading-7 text-slate-600">
                  Badgely shows the latest verified relationship we have, but
                  testing providers, online availability, exam security rules
                  and regional options can change. Always verify the final
                  delivery method before purchasing or scheduling.
                </p>
              </div>
