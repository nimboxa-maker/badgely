    ...
    <main>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
          Practical guides for choosing certifications, comparing
          options, and connecting credentials to real IT career paths.
        </p>

        <div className="mt-8 flex flex-wrap gap-x-7 gap-y-3 text-sm text-slate-300">
          <span className="inline-flex items-center gap-2">
            <Compass className="size-4 text-blue-300" />
            Decision-focused
          </span>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-slate-950">
            Featured certification guides
          </h2>

          <p className="mt-3 leading-7 text-slate-600">
            Each guide is designed to answer a specific decision question
            and then connect you to deeper certification, career-path,
            training, and study-resource pages.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          <Card className="p-6">
            ...
            <p className="mt-4 leading-7 text-slate-600">
              A balanced look at who Security+ fits, the current SY0-701
              exam, study expectations, and the career paths it can
              support.
            </p>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-950">
                  CCNA vs Network+: Which should you choose?
                </h3>
              </div>
            </div>

            <p className="mt-4 leading-7 text-slate-600">
              Compare vendor-neutral breadth with deeper Cisco-oriented
              networking and decide which certification best matches
              your starting point and career goal.
            </p>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-950">
                  Security+ vs SSCP: Which should you choose?
                </h3>
              </div>
            </div>

            <p className="mt-4 leading-7 text-slate-600">
              Compare a broad foundational security credential with a
              practitioner-oriented certification that includes an
              experience requirement for full certification.
            </p>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-950">
                  CISSP vs CISM: Which should you choose?
                </h3>
              </div>
            </div>

            <p className="mt-4 leading-7 text-slate-600">
              Compare broad security leadership and architecture
              coverage with a credential focused more directly on
              governance, risk, security programs, and management
              responsibilities.
            </p>
          ...
          <Card className="p-6">
            ...
            <p className="mt-4 leading-7 text-slate-600">
              Explore cybersecurity certifications by goal, from
              first-step foundations and SOC work to penetration
              testing, cloud security, and advanced architecture or
              leadership.
            </p>
          ...
          <Card className="p-6">
            ...
            <p className="mt-4 leading-7 text-slate-600">
              Explore cloud certifications by career goal, from
              first-step cloud fundamentals to engineering,
              architecture, operations, and advanced hybrid-cloud
              networking.
            </p>
