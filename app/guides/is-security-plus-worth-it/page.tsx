  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Is CompTIA Security+ worth it in 2026?",
          item: pageUrl,
        },
      ],
    },
    ...
    <main>
        ...
        aside={
          <HeroPanel>
            ...
            <h2 className="mt-3 text-2xl font-bold text-white">
              Security+ can be a strong first cybersecurity
              certification.
            </h2>

            <p className="mt-3 leading-7 text-slate-300">
              It makes the most sense when you already understand basic
              IT and networking and want a broad, vendor-neutral
              security foundation. It is a starting point—not a
              substitute for hands-on practice or experience.
            </p>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
          A practical look at who Security+ fits, when another first
          step may make more sense, what the current exam covers, and
          how the credential can fit into a longer cybersecurity path.
        </p>
          ...
          <div className="space-y-10">
            ...
            <section aria-labelledby="exam-snapshot">
              <h2
                ...
                className="text-3xl font-bold tracking-tight text-slate-950"
              >
                Current Security+ exam snapshot
              </h2>
              ...
              <Card className="mt-4 overflow-hidden p-0">
                <dl className="divide-y divide-slate-200">
                  {[
                    ...
                    [
                      "U.S. retail price",
                      "$439 USD; regional pricing may vary",
                    ],
                  ].map(([label, value]) => (
                    <div
                      key={label}
                      className="grid gap-1 px-6 py-4 sm:grid-cols-[180px_1fr]"
                    >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Exam pricing, availability, policies, and exam versions
                can change. Confirm current details with CompTIA and
                Pearson VUE before registering.
              </p>
            </section>
            ...
            <section aria-labelledby="domains">
              <h2
                ...
                className="text-3xl font-bold tracking-tight text-slate-950"
              >
                What SY0-701 emphasizes
              </h2>

              <p className="mt-3 max-w-3xl leading-7 text-slate-600">
                The largest single domain is Security Operations, but
                the exam is intentionally broad. You need to be
                comfortable connecting technical controls, threats,
            ...
            <section aria-labelledby="study-time">
              <h2
                ...
                className="text-3xl font-bold tracking-tight text-slate-950"
              >
                How long should you expect to study?
              </h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 leading-7 text-slate-600">
                      Your actual time depends on your networking,
                      systems, and security background. Someone already
                      working in IT may move faster; a beginner may need
                      additional time to build prerequisite knowledge
                      instead of memorizing security terms in
                      isolation.
                    </p>
                  </div>
                </div>
            ...
            <section aria-labelledby="pair-with">
              <h2
                ...
                className="text-3xl font-bold tracking-tight text-slate-950"
              >
                What should you pair with Security+?
              </h2>

              <p className="mt-3 leading-7 text-slate-600">
                Treat the certification as a knowledge framework. Pair
                the study with practical work: networking and
                operating-system troubleshooting, identity and
                access-control exercises, log review, vulnerability
                management practice, security configuration, and
                incident-response scenarios. The goal is to understand
                how the concepts behave in real environments—not just
                recognize definitions on a test.
              </p>
            </section>
            ...
            >
              ...
              >
                Explore the full Security+ record
              </h2>

              <p className="mt-3 max-w-2xl leading-7 text-slate-300">
                Review the detailed exam record, official resources,
                renewal information, related certifications, and
                verified source links before deciding how Security+
                fits your plan.
              </p>
          ...
          <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
              ...
              <dl className="mt-4 space-y-4 text-sm">
                ...
                <div>
                  ...
                  <dd className="mt-1 leading-6 text-slate-900">
                    Network+ level knowledge and about two years in a
                    security or systems administrator role, according
                    to CompTIA&apos;s recommendation.
                  </dd>
                </div>
              </dl>
            </Card>
            ...
            <Card className="p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Always verify current exam details directly with
                CompTIA before purchasing or scheduling.
              </p>
