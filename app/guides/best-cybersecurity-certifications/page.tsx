    ...
    <main>
        ...
        aside={
          <HeroPanel>
            ...
            <h2 className="mt-3 text-2xl font-bold text-white">
              The best cybersecurity certification depends on what you
              want to do next.
            </h2>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
          A practical way to choose among beginner,
          defensive-security, offensive-security, cloud-security, and
          advanced cybersecurity credentials without treating every
          learner as if they have the same destination.
        </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_320px]">
          <div className="space-y-10">
            <section aria-labelledby="method">
              ...
              <Card className="mt-4 p-6">
                <p className="leading-8 text-slate-700">
                  ...
                  career step. A certification can be excellent for one
                  goal and unnecessary for another.
                </p>
              </Card>
            </section>
            ...
            <section aria-labelledby="paths">
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                ...
                >
                  <Card className="h-full p-5 transition group-hover:border-blue-300 group-hover:shadow-sm">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      Build toward monitoring, triage, investigation,
                ...
                <Link
                  href="/career-paths/penetration-tester"
                  className="group"
                >
                  <Card className="h-full p-5 transition group-hover:border-blue-300 group-hover:shadow-sm">
                    <Crosshair
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      Move from security foundations into authorized
                ...
                <Link
                  href="/career-paths/cloud-security-engineer"
                  className="group"
                >
                  <Card className="h-full p-5 transition group-hover:border-blue-300 group-hover:shadow-sm">
                    <Cloud
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      Connect general security knowledge to cloud
                      identity, infrastructure, monitoring, and data
                      protection.
                    </p>
                  </Card>
                </Link>
                ...
                >
                  <Card className="h-full p-5 transition group-hover:border-blue-300 group-hover:shadow-sm">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      Follow a governance, risk, compliance, and
                      assurance-oriented route.
                    </p>
                  </Card>
                </Link>
              </div>
            ...
            <section aria-labelledby="more-options">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                These can be strong choices when their platform,
                training style, or job focus matches your environment.
              </p>
            ...
            <section aria-labelledby="first-cert">
              <h2
                ...
                className="text-3xl font-bold tracking-tight text-slate-950"
              >
                Which cybersecurity certification should you get
                first?
              </h2>

              <Card className="mt-4 p-6">
                <p className="leading-8 text-slate-700">
                  If you are completely new to cybersecurity, start by
                  strengthening basic computing and networking
                  knowledge, then consider an entry credential such as
                  ISC2 CC or Cisco CCST Cybersecurity. If you already
                  have general IT or networking experience and want a
                  broad vendor-neutral security foundation, Security+
                  is often the more natural next step. From there, let
                  the role you want determine whether you move toward
                  SOC analysis, security administration, penetration
                  testing, cloud security, governance, or advanced
                  architecture.
                </p>
          ...
          <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
            ...
            <Card className="p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Pair certification study with labs, projects,
                troubleshooting, communication skills, and practical
