    ...
    <main className="mx-auto flex min-h-[70vh] max-w-7xl items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md">
        <div className="mb-6 space-y-2">
          <p className="text-sm font-semibold uppercase tracking-[0.16em] text-blue-600">Get started</p>
          <h1 className="text-3xl font-bold tracking-tight">Create your Badgely account</h1>
          <p className="text-sm text-slate-600">Save certifications, career paths, and study progress in one place.</p>
        </div>
        ...
        <form action={signUp} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="displayName" className="text-sm font-semibold text-slate-800">Name</label>
            <input
              id="displayName"
              name="displayName"
              type="text"
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          ...
          <Link href="/sign-in" className="font-semibold text-blue-600 hover:text-blue-500">Sign in</Link>
        </p>
      </Card>
    </main>
  );
