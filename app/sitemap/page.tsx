...
export const metadata: Metadata = {
  title: "Sitemap | ThirdBadge",
  description:
    "Browse ThirdBadge certification categories, individual IT certifications, career paths, guides, resources, and company pages.",
};
    ...
    <main className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 max-w-3xl text-base leading-7 text-slate-600">
          Browse ThirdBadge certifications, career paths, guides, study
        ...
        <section className="mt-14 border-t border-slate-300 pt-8">
          ...
          <p className="mt-3 text-sm text-slate-600">
            ThirdBadge also maintains an XML sitemap for search engines.
          </p>
