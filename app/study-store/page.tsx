...
const publishers = [
  ...
  },
  {
    ...
    href: "https://www.wiley.com/en-us/grow/teach-learn/student-resources/exam-guides/sybex/",
...
const featuredResources = [
  {
    ...
    href: "https://www.ciscopress.com/store/ccna-200-301-official-cert-guide-volume-1-9780138229702",
    cover: "CCNA",
...
const certificationShelves = [
  {
    title: "CompTIA",
    description: "A+, Network+, Security+, Linux+, CySA+, PenTest+ and more.",
    publishers: "CompTIA • Wiley / Sybex • Pearson • Packt",
  },
  {
    title: "Cisco",
    description: "CCNA, CCNP, CyberOps, DevNet and networking references.",
    publishers: "Cisco Press • Pearson • O'Reilly",
  },
  {
    title: "Cybersecurity",
    description: "CISSP, CCSP, SSCP, CISA, CISM, Security+ and security skills.",
    publishers: "Wiley / Sybex • Pearson • Packt • O'Reilly",
  },
  {
    title: "Cloud",
    description: "AWS, Azure, Google Cloud and cloud architecture learning.",
    publishers: "Wiley / Sybex • Packt • O'Reilly • Pearson",
  },
  {
    title: "Linux & DevOps",
    description: "Linux+, Red Hat, Kubernetes, Docker, automation and operations.",
    publishers: "O'Reilly • Packt • Pearson • Wiley / Sybex",
  },
  {
    title: "Data & AI",
    description: "Data engineering, analytics, AI, machine learning and platform skills.",
...
const storePrinciples = [
  ...
  },
  {
    ...
    description:
      "Every card tells you who publishes or sells the resource before you leave Badgely, so the destination is never a surprise.",
  },
  {
    icon: ShoppingBag,
    title: "Buy from the source",
    description:
      "Badgely helps you discover the resource. Purchases, pricing, fulfillment, returns, and subscriptions stay with the external publisher or seller.",
  },
];
