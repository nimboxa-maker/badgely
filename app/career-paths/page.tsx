      ...
      <section className="relative overflow-hidden border-b border-blue-900 bg-slate-950 text-white">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-3xl">
            <div className="flex items-center justify-center gap-2 text-sm font-semibold uppercase tracking-[0.16em] text-blue-300">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-300">
              Explore step-by-step learning paths for common IT roles. Each path combines
              certification guidance with practical activities so you can see what to learn next
              and why it matters.
            </p>
          </div>
        </div>
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-slate-600">
            {careerPaths?.length ?? 0} role-focused paths currently
            available.
          </p>
          ...
          {(careerPaths ?? []).map((path) => (
            ...
            >
              <div className="flex flex-wrap justify-center gap-2">
                ...
                {path.audience_level ? (
                  <Badge>{path.audience_level}</Badge>
                ) : null}
              </div>
              ...
              <Link
                ...
                className="mt-6 inline-flex min-h-11 items-center justify-center gap-2 self-center rounded-xl bg-blue-700 px-5 py-2.5 font-semibold text-white transition hover:bg-blue-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
              >
                View career path
