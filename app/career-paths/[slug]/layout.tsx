      ...
      <div className="mx-auto w-full max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-2 max-w-3xl leading-7 text-slate-600">
            Explore the certification areas used in this roadmap, then compare training and study
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {certificationCategories.slice(0, 2).map((category) => {
              ...
              return (
                ...
                >
                  <p className="text-sm font-semibold text-blue-700">Certification area</p>
                  <p className="mt-1 font-bold text-slate-950">Browse {category}</p>
                </Link>
              );
            })}
